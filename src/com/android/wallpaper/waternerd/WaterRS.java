...
package com.android.wallpaper.waternerd;
...
class WaterRS extends RenderScriptScene {
    ...
    @SuppressWarnings({"FieldCanBeLocal"})
    private ProgramFragment mPfSky2;
    @SuppressWarnings({"FieldCanBeLocal"})
    private ProgramStore mPfsBackground;
    @SuppressWarnings({"FieldCanBeLocal"})
    private ProgramStore mPfsLeaf2;
    @SuppressWarnings({"FieldCanBeLocal"})
    private ProgramVertex mPvSky2;
    @SuppressWarnings({"FieldCanBeLocal"})
    ...
    public WaterRS(int width, int height) {
        super(width, height);
    ...
    protected ScriptC createScript() {
        mScript = new ScriptC_water(mRS, mResources, R.raw.water);
    ...
    static class WorldState {
        ...
        public float sky2SpeedX;
        public float sky2SpeedY;
        public int rotate;
    ...
    private void createState() {
        ...
        mWorldState.sky2SpeedX = random(-0.001f, 0.001f);
        mWorldState.sky2SpeedY = random(0.00008f, 0.0002f);
    ...
    private void loadTextures() {
        mScript.set_g_TRiverbed(loadTexture(R.drawable.pond2));
    }
    ...
    private void createProgramFragment() {
        ...
        builder.setTexture(ProgramFragmentFixedFunction.Builder.EnvMode.MODULATE,
                           ProgramFragmentFixedFunction.Builder.Format.RGBA, 0);
        mPfSky2 = builder.create();
        mPfSky2.bindSampler(mSampler, 0);

        mScript.set_g_PFSky2(mPfSky2);
    }
    ...
    private void createProgramVertex() {
        ...
        mPvSky2 = builder.create();
        ((ProgramVertexFixedFunction)mPvSky2).bindConstants(mPvOrthoAlloc);

        mScript.set_g_PVSky2(mPvSky2);
